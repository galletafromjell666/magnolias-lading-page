  ...
  return (
    <div className="w-full bg-primary text-selection-disable">
      <div className="mx-auto bg-primary pb-2 h-[auto] w-[90%]  md:w-[80%] 3xl:container 3xl:w-[80%] xl:px-8 md:pb-8">
        ...
        <div className="grid font-averia pb-6 grid-cols-2 h-auto w-full grid-rows-custom grid-flow-row gap-6 gap-y-2 md:gap-x-12 md:pb-8 md:h-[700px] md:grid-cols-3 xl:h-[1000px] xl:gap-x-20 md:gap-y-6 ">
          {test01.map((uwu) => {
            //console.log(uwu);
